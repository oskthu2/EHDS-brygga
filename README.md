...
| **GetCareDocumentation: DocBook-innehåll** | `clinicalDocumentNoteText` base64-kodas rakt av; transformeras inte till FHIR Narrative. `DocBookToNarrativeTransformer` finns och är testad men är inte inkopplad. Se DOC-004. | `GetCareDocumentationMapper.java`, `DocBookToNarrativeTransformer.java` |
